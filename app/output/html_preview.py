...
class HtmlPreviewRenderer:
    ...
    def render(self, report: DailyReport) -> str:
        ...
        for category, icon, accent in self._categories:
            filtered = [cluster for cluster in report.clusters if cluster.category == category][:5]
            if filtered:
